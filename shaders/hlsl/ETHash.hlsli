...
// since we have a hard 2GB limit on the dataset size (0x80000000 byte)
[[vk::binding(1, 0)]]
RWStructuredBuffer<uint512> dataset0 : register(u0); //index [0x0000000, 0x1FFFFFF]
[[vk::binding(2, 0)]]
RWStructuredBuffer<uint512> dataset1 : register(u1); //index [0x2000000, 0x3FFFFFF]
[[vk::binding(3, 0)]]
RWStructuredBuffer<uint512> dataset2 : register(u2); //index [0x4000000, 0x5FFFFFF]
[[vk::binding(4, 0)]]
RWStructuredBuffer<uint512> dataset3 : register(u3); //index [0x6000000, 0x7FFFFFF]
